...
import com.example.Hvegan.adapters.CartAdapter;
import com.example.Hvegan.databinding.ActivityCheckoutBinding;
import com.example.Hvegan.model.Product;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CartAdapter(this, products, new CartAdapter.CartListener() {
            ...
            public void onQuantityChanged() {
                binding.subtotal.setText(String.format(" DH %.2f",cart.getTotalPrice()));
            }
        });
        ...
        binding.total.setText(" DH " + totalPrice);
